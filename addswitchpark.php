<html>
	...
	<body class="landing">
		...
		<header id="header" class="alt">
			<h1><strong><a href="">iParker HARDWARE</a></strong></h1>
		</header>
			...
			<section id="banner" class="wrapper style1">
				<div class="container">
					<header class="major special">
						<h2>Light Switch Representation<h2>
                        ...
                        <div class="slideshow-container">
                            ...
                            <div class="mySlides fade">
                                <div style="background: url('images/4thflr.jpg'); border: 1px solid #ddd; border-radius: 4px; width:550px; height:486px; position: relative;">
                                    ...
                                    <img src='images/red.png' style="position: relative; top:23px; left:128px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:23px; left:71px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:103px; left:5px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:143px; left:-17px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:173px; left:-39px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:203px; left:-63px; width:15px; height:15px;">

                                    <img src='images/red.png' style="position: relative; top:240px; left:-87px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:269px; left:-110px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:299px; left:-133px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:327px; left:-155px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:354px; left:-178px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:417px; left:-150px; width:15px; height:15px;">

                                    <img src='images/red.png' style="position: relative; top:417px; left:-145px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:416px; left:-134px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:414px; left:-130px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:413px; left:-127px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:413px; left:-124px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:413px; left:-115px; width:15px; height:15px;">

                                    <img src='images/red.png' style="position: relative; top:413px; left:-113px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:413px; left:-109px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:412px; left:-106px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:412px; left:-97px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:412px; left:-95px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:363px; left:405px; width:15px; height:15px;">

                                    <img src='images/red.png' style="position: relative; top:323px; left:420px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:299px; left:396px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:265px; left:373px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:240px; left:350px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:212px; left:327px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:186px; left:303px; width:15px; height:15px;">

                                    <img src='images/red.png' style="position: relative; top:150px; left:280px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:122px; left:258px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:93px; left:235px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:54px; left:211px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:63px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:12px; width:15px; height:15px;">

                                    <img src='images/red.png' style="position: relative; top:88px; left:-40px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:-90px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:-150px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:-200px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:-253px; width:15px; height:15px;">
                                    <img src='images/red.png' style="position: relative; top:88px; left:-306px; width:15px; height:15px;">
                                </div>
                            </div>
