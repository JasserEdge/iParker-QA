...
<html>
	...
	<body>
        ...
        <!-- Toggle buttons -->
        <div class="switch-r justify-content-even">
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form11" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot11"] == "1-1"){echo "checked";} ?> disabled>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form12" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot12"] == "1-2"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form13" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot13"] == "1-3"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form14" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot14"] == "1-4"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form15" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot15"] == "1-5"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form21" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot21"] == "2-1"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form22" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot22"] == "2-2"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form23" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot23"] == "2-3"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form24" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot24"] == "2-4"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form25" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot25"] == "2-5"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form31" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot31"] == "3-1"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form32" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot32"] == "3-2"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form33" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot33"] == "3-3"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row mb-2">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form34" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot34"] == "3-4"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
                ...
                <div class="d-flex flex-row">
                    ...
                    <label class="custom-toggle mr-2">
                        <form method="post" id="form35" action="addparkspot.php"> 
                            <input type="checkbox" <?php if($_SESSION["spot35"] == "3-5"){echo "checked";} ?> disabled>
                            <span class="custom-toggle-slider rounded-circle" ></span>
                        </form>
                    </label>
