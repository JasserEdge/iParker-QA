	...
	<body>
        ...
        <div class="section section-components">
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <div class="tab-content" id="myTabContent">
                                <figure class="tab-pane fade show active" id="tabs-text-1" role="tabpanel" aria-labelledby="tabs-text-1-tab">
                                    <img class="img-fluid" src="images/2ndflr.jpg" alt="">
                                </figure>
            ...
            <div class="col-md-4 m-auto">
                <button type="button" class="btn btn-block btn-primary mb-3" data-toggle="modal" data-target="#modal-default">Park now</button>
